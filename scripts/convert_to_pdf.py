...
#     header_para = Paragraph(f'<a name="{section_name}"/>{header_text}', styles['CustomSectionHeader'])
...
#         for year in years:
#             # Year divider with bookmark
#             year_para = Paragraph(f'<a name="year_{year}"/>Fiscal Year {year}', styles['CustomYearHeader'])
...
#         logo_path="/Users/gkg/PycharmProjects/Fintel/scripts/logo.png",
#         watermark_path="/Users/gkg/PycharmProjects/Fintel/scripts/watermark.png",
#     )
