...
from eon.core.logging import setup_cli_logging
...
from eon.cli.utils import read_ticker_file, ANALYSIS_TYPE
...
def batch(
    ...
    \b
    # Use a custom workflow (run 'eon workflows' to list them)
    eon batch tickers.csv --analysis-type custom:examples.moonshot_analyzer

    \b
    # Analyze foreign company filings (20-F)
    eon batch foreign_tickers.csv --filing-type 20-F --years 5
