...
from eon.cli.utils import read_ticker_file
from eon.analysis.comparative import ContrarianScanner
from eon.ui.database import DatabaseRepository
from eon.ui.services import create_analysis_service
...
def scan_contrarian(
    ...
    Examples:
      ...
      eon scan-contrarian tickers.csv --min-score 75

      # Show top 10 high-confidence opportunities
      eon scan-contrarian tickers.csv --top-n 10 --min-confidence HIGH

      # Use pre-computed success factors
      eon scan-contrarian tickers.csv --success-factors-dir ./factors

      # Export results to CSV
      eon scan-contrarian tickers.csv --output gems.csv --min-score 80
    """
    config = get_config()
